...
@Component({
  selector: 'app-found',
  standalone: true,
  imports: [Navbar, Footer, FilterBar, SideFilters, PetCard, LocationFilterModal, MapComponent],
...
export class FoundComponent implements OnInit, OnDestroy {
  ...
  private async loadEspecies(): Promise<void> {
    try {
      ...
      console.error('Error al cargar especies en encontrados:', err);
    }
  }
