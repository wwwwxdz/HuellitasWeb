import { Component, inject, signal, output, HostListener, DestroyRef, effect } from '@angular/core';
    ...
    this.searchSubject
      .pipe(
        ...
        switchMap((q) => {
          ...
          return this.userService.searchMentions(q).pipe(finalize(() => this.isLoading.set(false)));
        }),
